import {turno_check} from './accordion_utils.js'
...
export function createTableConceptos(data) {
    const table = document.createElement('table');
    table.classList.add('table');
...
export function createTableTotales(data) {
    const table = document.createElement('table');
    table.classList.add('table');
...
export function insertAccordionItemIntoContainer(accordionItem) {
