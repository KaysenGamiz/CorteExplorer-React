import {get_corte_by_RCC, get_cortes_between_RCCs, get_corte_by_date, get_cortes_between_dates} from '../services/api.js';
...
export function delete_accordion_items() {
